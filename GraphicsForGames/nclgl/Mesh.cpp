...
void Mesh::SetPatches() {
	type = GL_PATCHES;
}

Mesh* Mesh::GenerateQuad(float texSize) {
	Mesh* m = new Mesh();
	m->numVertices = 4;
	...
	m->textureCoords[0] = Vector2(0.0f, texSize);
	m->textureCoords[1] = Vector2(0.0f, 0.0f);
	m->textureCoords[2] = Vector2(texSize, texSize);
	m->textureCoords[3] = Vector2(texSize, 0.0f);
